...
class ContactController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:contactos')->only(['index']);
        $this->middleware('permission:contactos-crear')->only(['create', 'store']);
        $this->middleware('permission:contactos-editar')->only(['edit', 'update']);
        $this->middleware('permission:contactos-eliminar')->only(['destroy']);
    }
