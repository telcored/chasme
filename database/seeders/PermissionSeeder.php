...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'Ver créditos', 'slug' => 'creditos'],
            ['name' => 'Crear créditos', 'slug' => 'creditos-crear'],
            ['name' => 'Editar créditos', 'slug' => 'creditos-editar'],
            ['name' => 'Eliminar créditos', 'slug' => 'creditos-eliminar'],
        ];
