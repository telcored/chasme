...
class FollowUpsController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:seguimientos')->only(['index']);
        $this->middleware('permission:seguimientos-crear')->only(['create', 'store']);
        $this->middleware('permission:seguimientos-editar')->only(['edit', 'update']);
        $this->middleware('permission:seguimientos-eliminar')->only(['destroy']);
    }
